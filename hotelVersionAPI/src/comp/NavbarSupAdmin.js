...
import admin from './image/icons8-paramètres-administrateur-homme-50.png';
        ...
        <nav className="navbar navbar-expand-lg bg-gradient">
            <div className="container-fluid">
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <Link className="navbar-brand" to="/accueiladminsup">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <ul className="navbar-nav" id="custumFont">
                        ...
                        <li className="nav-item dropdown" >
                            <Link class="dropdown-item" to="/gestionchambres">GESTION&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</Link>
                            <ul className="dropdown-menu fade-up">
                                ...
                                <li>
                                    <Link className="dropdown-item" to="/gestionadmins">
                                        <img src={admin} height="31" className="mt-2 pl-2" />&nbsp;
                                        ADMINS
                                    </Link>
                                </li>
                            </ul>
